...
{HexIntegerLiteral}					{ yylval.Int_Literal = Convert.ToInt32(yytext.Substring(2).Replace("_", ""), 16); return (int)Tokens.INT_LITERAL;}													//The value added by Dambar Thapa 08/03/19
{BinaryIntegerLiteral}				{ yylval.Int_Literal = Convert.ToInt32(yytext.Substring(2).Replace("_", ""), 2); return (int)Tokens.INT_LITERAL; }												//The value is added by Chao Jiang 07/03/19
{OctalIntegerLiteral}				{ yylval.Int_Literal = Convert.ToInt32(yytext.Substring(1).Replace("_", ""), 8); return (int)Tokens.INT_LITERAL; }
{DecimalIntegerLiteral}				{ yylval.Int_Literal = int.Parse(yytext); return (int)Tokens.INT_LITERAL;}
